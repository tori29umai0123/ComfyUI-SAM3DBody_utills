...
const DICT = {
  ja: {
    ...
    "make.hint": "MHR 既定の T-pose 素体に対して、下の Body Preset スライダーで体形を調整できます。完成したら「json をダウンロード」で JSON をローカル保存してください。",
    ...
    "video.rebuilding": "ボディプリセット差し替え中…",
    "video.hint": "※ 体形は下の Body Preset パネル (preset / JSON) で指定した値を rig にベイクします。モーション推定後に preset を切り替えると、ボディプリセットを差し替えた FBX が自動再生されます。",

    "body_preset.preset_placeholder": "(preset)",
    "body_preset.load": "Load",
    "body_preset.reset": "Reset",
    "body_preset.export_fbx": "FBX をダウンロード",
    "body_preset.export_bvh": "BVH をダウンロード",
    "body_preset.body_summary": "Body (PCA 9 軸)",
    "body_preset.bone_summary": "Bone length (4 部位)",
    "body_preset.bs_summary": "Blendshapes",
    "body_preset.json_drop": "ボディプリセット JSON をアップロード (任意)",
    "body_preset.json_loaded": "JSON 適用済み:",
    "body_preset.preset_loaded": "preset 適用済み:",
    ...
    "viewport.range_enter": "画像範囲",
    "viewport.range_exit": "決定",
    "viewport.range_reset": "reset",
    "viewport.bg_color": "背景色",
    "viewport.gizmo_translate": "移動",
    "viewport.gizmo_rotate": "回転",
    "viewport.reset_translate": "移動リセット",
    "viewport.reset_rotate": "回転リセット",
    "viewport.toggle_image": "入力画像表示",
    ...
    "tooltip.range_select": "ドラッグでレンダリング画像の出力範囲を指定（pose_image 出力に反映）",
    "tooltip.range_reset": "保存された範囲指定をリセットして全画面出力に戻す",
    "tooltip.bg_color": "pose_image 出力の背景色を指定（既定は白）",
    "tooltip.gizmo_translate": "ボディアンカーの移動 (W)",
    "tooltip.gizmo_rotate": "ボディアンカーの回転 (E)",
    "tooltip.reset_translate": "現在の移動量を 0 に戻す",
    "tooltip.reset_rotate": "現在の回転量を 0 に戻す",
    "tooltip.toggle_image": "右ビューポートに入力画像オーバーレイを表示／非表示",
    "tooltip.hand_flip": "読み込んだ手の画像を左右反転する",
    "tooltip.make_download": "現在の Body Preset スライダー値を body preset JSON としてダウンロード",
  ...
  en: {
    ...
    "tab.image": "Image",
    "tab.video": "Video",
    "tab.make": "Body Preset",
    "tab.admin": "Preset Admin",

    "section.input": "Input",
    "section.video": "Video → animated FBX",
    "section.make": "Body Preset",
    ...
    "make.hint": "Tweak the MHR neutral T-pose body with the sliders below. Hit \"Download JSON\" to save the current body shape as a JSON file.",
    ...
    "video.rebuilding": "rebuilding FBX with new body preset…",
    "video.hint": "The Body Preset panel below (preset / JSON) is baked into the rig. After motion inference, swapping a preset re-builds the FBX with the new body automatically.",

    "body_preset.preset_placeholder": "(preset)",
    "body_preset.load": "Load",
    "body_preset.reset": "Reset",
    "body_preset.export_fbx": "Download FBX",
    "body_preset.export_bvh": "Download BVH",
    "body_preset.body_summary": "Body (PCA 9 axes)",
    "body_preset.bone_summary": "Bone length (4 chains)",
    "body_preset.bs_summary": "Blendshapes",
    "body_preset.json_drop": "Upload body preset JSON (optional)",
    "body_preset.json_loaded": "JSON applied:",
    "body_preset.preset_loaded": "preset applied:",
    ...
    "viewport.range_enter": "Image range",
    "viewport.range_exit": "Confirm",
    "viewport.range_reset": "Reset",
    "viewport.bg_color": "Background color",
    "viewport.gizmo_translate": "Move",
    "viewport.gizmo_rotate": "Rotate",
    "viewport.reset_translate": "Reset move",
    "viewport.reset_rotate": "Reset rotation",
    "viewport.toggle_image": "Show input",
    "input.lhand_drop": "Left hand image",
    "input.rhand_drop": "Right hand image",
    ...
    "tooltip.range_select": "Drag to define the output region for pose_image",
    "tooltip.range_reset": "Clear the saved range and fall back to full-viewport output",
    "tooltip.bg_color": "Background color used for the pose_image output (default: white)",
    "tooltip.gizmo_translate": "Translate the body anchor (W)",
    "tooltip.gizmo_rotate": "Rotate the body anchor (E)",
    "tooltip.reset_translate": "Zero out the manual translation",
    "tooltip.reset_rotate": "Zero out the manual rotation",
    "tooltip.toggle_image": "Toggle the input-image overlay on the viewport",
    "tooltip.hand_flip": "Mirror the loaded hand image in place",
    "tooltip.make_download": "Download the current Body Preset slider values as a body preset JSON",
